      ...
      <div className="container-edge py-16 grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5">
          <div className="flex items-center gap-3">
              ...
              width={48}
              height={48}
              className="h-12 w-12 object-contain bg-ivory rounded-md p-1"
            />
            <div>
              <div
              ...
              <div className="text-[10px] tracking-[0.18em] uppercase text-ivory/70">
          ...
          <div className="mt-6 text-sm text-ivory/85">
            <a href="mailto:jenesiscdc@gmail.com" className="hover:text-gold">
        ...
        <div className="md:col-span-2">
          <div className="text-[11px] uppercase tracking-[0.18em] text-ivory/60 mb-4">
            Explore
          </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2.5 text-sm">
            <li>
              <Link to="/contact" search={{ interest: "Coalition Partner" } as never} className="hover:text-gold">
                Become a Partner
              </Link>
            </li>
            <li>
              <Link to="/contact" search={{ interest: "Volunteer" } as never} className="hover:text-gold">
                Volunteer
              </Link>
            </li>
            <li>
              <Link to="/contact" search={{ interest: "Sponsor" } as never} className="hover:text-gold">
                Sponsor
              </Link>
            </li>
          </ul>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link to="/" hash="impact" className="hover:text-gold">Points of Impact</Link></li>
          </ul>
        </div>
      </div>

      <div className="border-t border-ivory/10">
        <div className="container-edge py-5 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-ivory/55">
          <div>
            © {new Date().getFullYear()} Jenesis Community Development Corporation. All rights reserved.
          </div>
